  ...
  return (
    <section className="hero-bg px-4 flex flex-col-reverse lg:flex-row  lg:px-24 py-28">
      ...
      <div className="text-[#ED6923] flex-col gap-y-10 w-full lg:w-1/2 pt-32">
        <h1 className="text-7xl text-[#ED6923] font-rancho">Hungry?</h1>

        <h1 className="font-bold text-7xl   leading-snug">
       
          <span className="text-black">Let Us</span> Bring  <br></br> The Feast to You
        </h1>
        ...
        <div className="flex items-center bg-white mt-6 rounded-xl shadow-md overflow-hidden border border-orange-300 w-full max-w-xl">

  <input
    type="text"
    placeholder="Enter your location"
    className="flex-grow px-4 py-[15px] text-gray-600 placeholder:text-gray-400 focus:outline-none"
  />
...
></Image>
  ...
  <button className="bg-[#F37022] hover:bg-orange-600 text-white text-lg font-semibold px-6 py-[16px] rounded-r-xl m-0 transition">
    Find Food
  </button>
</div>
  ...
  {/* Text & Ratings */}
  <h4 className="text-xl font-semibold text-gray-800">Satisfied Customer</h4>
...
<div className="w-80 h-36 p-4 bg-white/40 backdrop-blur-[50px] absolute -bottom-20 rounded-lg z-10 "> 
<div className="flex gap-x-4">
  ...
  <div className="space-y-[3px] py-4"><h1 className="text-[16px] font-semibold">Flavor Fusion Bistro</h1>
  <h4 className="text-[#3D3D3D] text-[12px]">Kaliurang, Seleman</h4>
  <h6 className="flex items-center gap-2">4.9 <Image
   src={'/star.png'}
        alt="star"
        className="h-4 w-4"
        width={10}
...
<div className="h-20 w-40 bg-white/80 backdrop-blur-[50px]  -bottom-10 right-50 rounded-lg  absolute z-10"> 
